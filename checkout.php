...
<!-- checkout -->
	<div class="checkout">
		<div class="container">
			<h1>Terima kasih, <?=$_SESSION['name']?> telah membeli <?php echo $itungtrans3 ?> barang di Moy Comp</span></h1>
			...
			<hr>
			<br><center>
			<h2>Total harga yang tertera di atas sudah include ongkos kirim sebesar Rp 10.000</h2>
